package pro.kensait.brain24.openai;
...
import pro.kensait.brain24.exception.OpenAIClientException;
import pro.kensait.brain24.exception.OpenAIInsufficientQuotaException;
import pro.kensait.brain24.exception.OpenAIInvalidAPIKeyException;
import pro.kensait.brain24.exception.OpenAIRateLimitExceededException;
import pro.kensait.brain24.exception.OpenAITokenLimitOverException;
import pro.kensait.brain24.exception.RetryCountOverException;
import pro.kensait.brain24.exception.TimeoutException;
...
;public class ApiClient {
    ...
    private static void sleepAWhile(int retryInterval) {
        try {
